        ...
        >
          ...
          {this.state.password_constraints && (
            ...
            >
              ...
              <Text style={styles.boldText}>You password must have: </Text>
              ...
              <Text style={styles.boldText}>Strength: </Text>

              <BarPasswordStrengthDisplay
                labelVisible={false}
                minLength={8}
                levels={barlevels}
                barStyle={{ height: "100%", borderRadius: 50 }}
                barContainerStyle={{
                  alignSelf: "center",
                  height: "20%",
                  borderRadius: 50,
            ...
            >
              ...
              >
                <Icon
                  color="#01a7a6"
                  type="antdesign"
                  name={this.state.password_show ? "eye" : "eyeo"}
                  onPress={() =>
            ...
            >
              ...
              >
                <Icon
                  color="#01a7a6"
                  type="antdesign"
                  name={this.state.confirm_password_show ? "eye" : "eyeo"}
                  onPress={() =>
                    this.setState({
            ...
            <View>
              ...
              >
                ...
                <Text style={styles.text4}>
                  ...
                  elit. Ac turpis egestas maecenas pharetra convallis. Ipsum
                  dolor sit amet consectetur adipiscing. Cursus in hac habitasse
                  platea. Egestas quis ipsum suspendisse ultrices gravida dictum
                  fusce. Nibh mauris cursus mattis molestie a iaculis at erat
                  pellentesque. Imperdiet sed euismod nisi porta lorem mollis
                  aliquam. Feugiat nisl pretium fusce id. In eu mi bibendum
                  neque egestas congue quisque egestas. Enim neque volutpat ac
                  tincidunt vitae semper quis lectus. Vel orci porta non
                  pulvinar neque laoreet suspendisse. Nec feugiat in fermentum
                  posuere urna. Scelerisque viverra mauris in aliquam sem
                  fringilla. Varius vel pharetra vel turpis nunc eget lorem.
                  Sagittis nisl rhoncus mattis rhoncus urna neque viverra justo
                  nec. Egestas integer eget aliquet nibh praesent tristique
                  magna sit amet. Eu feugiat pretium nibh ipsum consequat nisl
                  vel. Congue eu consequat ac felis donec et odio pellentesque.
                  Arcu non sodales neque sodales ut etiam sit. Enim lobortis
                  scelerisque fermentum dui faucibus in ornare quam. Proin
                  fermentum leo vel orci porta non pulvinar neque laoreet.
                  Integer enim neque volutpat ac. In fermentum posuere urna nec.
