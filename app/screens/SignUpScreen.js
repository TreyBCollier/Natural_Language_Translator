...
class SignUpScreen extends React.Component {
  ...
  allFieldsCorrect() {
    if (this.state.first_name != null(this.state.last_name != null if (this.state.email != null   if (this.checkEmailIsUnique(this.state.email)     if (this.state.username != null       if (this.state.password != null && this.passwordConstraints()         if (        this.state.confirm_password != null &&        this.state.confirm_password == this.state.password      console.log("hello");        return true;      } else {        alert("Please confirm your password");        return false;           } else {      alert("Please provide a Password that follows the constraints");      return false;       } else {    alert("Please provide a Username");    return false;   } else return false;else {alert("Please provide an Email address");return false;      } else {
