...
MKINSTALLDIRS   := ./install-sh -c -d

CLEAN += $(OBJ_BUILD)/freetype-config \(OBJ_BUILD)/freetype2.pc

DISTCLEAN += $(OBJ_BUILD)/config.cache      $(OBJ_BUILD)/config.log        $(OBJ_BUILD)/config.status \   $(OBJ_BUILD)/unix-def.mk       $(OBJ_BUILD)/unix-cc.mk        $(OBJ_BUILD)/ftconfig.h        $(LIBTOOL           $(OBJ_BUILD)/Makefile
