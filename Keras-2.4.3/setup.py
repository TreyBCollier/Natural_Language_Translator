...
setup(name='Keras',
      ...
      license='MIT',
      install_requires=['numpy>=1.9.1',   'scipy>=0.14',   'pyyaml',   'h5py'],
      extras_require={'visualize': ['pydot>=1.2.4'],'tests': ['pytest',pytest-pep8',pytest-xdist',flaky',pytest-cov',pandas',requests',markdown'],
      },
