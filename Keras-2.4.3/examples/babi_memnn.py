...
try:
    path = get_file('babi-tasks-v1-2.tar.gz','https://s3.amazonaws.com/text-datasets/'      'babi_tasks_1-20_v1-2.tar.gz')
except:
...
challenges = {
    ...
    'single_supporting_fact_10k': 'tasks_1-20_v1-2/en-10k/qa1_'  'single-supporting-fact_{}.txt',
    # QA2 with 10,000 samples
    'two_supporting_facts_10k': 'tasks_1-20_v1-2/en-10k/qa2_''two-supporting-facts_{}.txt',
}
