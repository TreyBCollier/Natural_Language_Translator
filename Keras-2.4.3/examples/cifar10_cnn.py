...
if not data_augmentation:
    ...
    datagen = ImageDataGenerator(
        ...
        rotation_range=0,  # randomly rotate images in the range (degrees, 0 to 180)randomly shift images horizontally (fraction of total width)
        width_shift_range=0.1,randomly shift images vertically (fraction of total height)
        height_shift_range=0.1,
        shear_range=0.,  # set range for random shear
        zoom_range=0.,  # set range for random zoom
        channel_shift_range=0.,  # set range for random channel shiftsset mode for filling points outside the input boundaries
        fill_mode='nearest',
        cval=0.,  # value used for fill_mode = "constant"
        horizontal_flip=True,  # randomly flip images
        vertical_flip=False,  # randomly flip imagesset rescaling factor (applied before any other transformation)
