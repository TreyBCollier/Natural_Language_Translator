...
plt.plot(range(epochs),
         history_model1.history['val_loss'],g-','Network 1 Val Loss')
plt.plot(range(epochs),
         history_model2.history['val_loss'],r-','Network 2 Val Loss')
plt.plot(range(epochs),
         history_model1.history['loss'],g--','Network 1 Loss')
plt.plot(range(epochs),
         history_model2.history['loss'],r--','Network 2 Loss')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
